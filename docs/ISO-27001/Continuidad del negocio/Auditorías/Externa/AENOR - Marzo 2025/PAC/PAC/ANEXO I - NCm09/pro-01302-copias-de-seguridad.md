...
|licabilidad Aplicaplantación G2- Implementado|Col2|Col3|Col4|
|---|---|---|---|
...
|plicabilidadplantaciónadurez|GL3|Aplica2- Implementado-Proceso definido|
|---|---|---|
|Denuncias internas|Art. 24 LOPDGDD|Plazo máximo de 3 meses ydespués supresión física.|


|8 Codificación seguralicabilidad|PROCEDIMIENTO DECOPIAS DE SEGURIDADY RESPALDO|Código: PRO-013.02|
|---|---|---|
||USO OFICIAL INTERNO|Fecha de vigor: 19/03/2025|
