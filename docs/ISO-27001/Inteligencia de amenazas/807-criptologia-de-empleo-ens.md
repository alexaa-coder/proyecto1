...
|KDF / Especificaciones|Col2|Mecanismo en el que sebasan|CAT|
|---|---|---|---|
...
|1. REFERENCIASás de las señaladas en los pies de página que se han in|cluido a lo la|
|---|---|
...
|das.|Col2|Col3|Col4|Col5|Col6|
|---|---|---|---|---|---|
|**Versión SSH**|**Están**|**d**|**ar**|**CAT**||
|_SSHv2_|_RFC 4251__RFC 4252__RFC 4253__RFC 4254_|_RFC 4251__RFC 4252__RFC 4253__RFC 4254_|_ 1_|||
|_SSHv2_|_RFC 4251__RFC 4252__RFC 4253__RFC 4254_|_RFC 4251__RFC 4252__RFC 4253__RFC 4254_|_ 1_|**R **|**R **|
...
|pública a un cierto servidor web,frir un ataque de tipo Man in the M|con el fin de reducir eliddle (MitM).|Col3|Col4|Col5|
|---|---|---|---|---|
...
|xcel de hallazgos encontrados para faciliEsquema de Firma|EstándarIKEv2|Longitud declave (bits)|Fortaleza(bits)|CAT|
|---|---|---|---|---|
...
|s compartidosivos que se compartieron o|utilizaron durante la reunión, como pre|sentaciones, actas, o documentos técnicos.Mínima longitud del PIN: 6 caracteresalfanuméricos.Máximo número de intentos fallidosde autenticación: entre 10 y 5|
|---|---|---|
