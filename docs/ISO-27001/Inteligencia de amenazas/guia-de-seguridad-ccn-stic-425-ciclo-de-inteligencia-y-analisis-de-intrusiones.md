...
|Col1|Col2|Col3|
|---|---|---|
|**CCN-STIC-425**|**Ciclo d**|** e Inteligencia y Análisis de Intrusio**|
|88. **La intención**: Aunque layudando a adoptar las d|a_intención_ es un aspecto esen  cisiones de mitigación más op|cial para analizar las intrusion    rtunas, no constituye en sí mis|
...
|La solidez de aquellas necesidades del adversario que puvíctima.|eden ser sati|
|---|---|
|El riesgo que el adversario percibe en relación con sus accEl coste que el adversario debe asumir para mantener sus aLa singularidad de la víctima para satisfacer una neinmanencia en el tiempo.El nivel de esfuerzo y recursos requeridos para resistir a la|iones.     cciones.    cesidad deter      persistencia.|
...
|incrementarse en el tiempo, si se aso de la transformación de una erés, cuando el adversario, una|dan las condicio víctima, de Víc a vez accedida,|
|---|---|
|erés, cuando el adversario, un especial importancia para él.|vez accedida,|
|  Modelo de Diamante puede ampli|arse incorporan|
| s de lo que más adelante definirem|    os como_Hilos_|
|n desarrollarse toda clase de ana capaces de dar respuesta a pregun|íticas relaciona    tas tales como:|
| na entidad concreta ha sido víctim|    a de un ataque?|
| onjunto común de víctimas?||
...
Los arcos están etiquetados con una tupla del tipo: , donde:
