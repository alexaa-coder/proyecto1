---
id: adr-001-02_informe-de-analisis-de-riesgos-2024
...
|Firma:|<br />[FIRMA DIGITAL]<br />`SANCHEZ DAVID -`<br />` el día`<br />`10/04/2025`<br /> <br /> <br /><br /> <br />|<br /> <br /> <br /> <br /> <br /> <br />`Firmado por`<br />`RODRIGO RIVERO,`<br />`CARLOS`<br />`(AUTENTICACIÓN) el`<br />~~`ía 10/04/2025 con`~~|<br />`Firmado por`<br />` CARLOS`<br />`ZUÑIGA (R:`<br />`****8690*) el día`<br />~~`10/04/2025 con un`~~|
...
Los niveles de riesgos tomados en consideración para la realización del análisis de riesgos se calculan multiplicando la probabilidad de que suceda el riesgo por el impacto que tendría en
el caso de que suceda. Primero se establecen valores del 1 al 4 para la probabilidad y el impacto, para posteriormente multiplicar esos valores.
