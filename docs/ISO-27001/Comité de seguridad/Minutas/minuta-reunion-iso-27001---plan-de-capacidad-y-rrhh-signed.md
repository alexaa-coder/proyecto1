7/4/25, 12:22 [FORMULARIO] Minuta reunión
...
# David Pozo Sánchez 14:59




&gt; Table omitted (Table 1): duplicated data detected.
&gt; Source document: [Minuta reunión] ISO 27001 - Plan de capacidad y RRHH_signed.pdf



ISO 27001 - Plan de capacidad y RRHH
...
|Col1|El modo túnel, por lo tanto, ofrece una mayor seguridad que el modo transporte.Por ello, siempre que sea posible se trabajará en esta configuración. La elección del|Col3|
|---|---|---|
|2/4/2|025||
|2/4/2|||
...
Revisión del plan de auditoría externa (fase 2) de la ISO 27001
Plan de capacidad de Spika Tech
Documento sobre gestión de identidades en Spika Tech (RRHH)
...
Confirmar pruebas de concepto en dos semanas.
        ...
        - Priorizar las no conformidades mayores, después las menores, y por último las observaciones.

        - Realizar un plan de capacidad anual
...
María López: Revisar presupuesto final (25/01/2025).
        ...
        - David Pozo: Terminar de hacer el plan de acciones de ambas auditorías.

        - David Pozo: Hablar con Cyberxia para pedir la plantilla del documento de gestión de identidades.

        - Administración: Preparar los puntos principales del plan de capacidad.
...
[Plan de capacidad y RRHH_David Pozo Sánchez.docx](https://spikatech-my.sharepoint.com/personal/fernando_pozo_spikatech_com/_layouts/15/Doc.aspx?sourcedoc=%7B05F61EE5-A2E7-4DE9-81AC-A50F7FD26CF0%7D&file=Plan%20de%20capacidad%20y%20RRHH_David%20Pozo%20S%C3%A1nchez.docx&action=default&mobileredirect=true)
...
```
      ...
      (AUTENTICACIÓN) el día 16/04/2025 con un
