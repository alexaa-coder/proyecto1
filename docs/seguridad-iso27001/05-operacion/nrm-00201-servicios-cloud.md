...
|38 ES|POLÍTICA DEDESCONEXIÓNDIGITALDiario Oficial de la Unión Europea|Código: PLT-005.0127.1|
|---|---|---|
||USO INTERNORESTRINGIDO|Fecha de vigor: 26/02/2025|
...
|. Cuando las autoridades de controlna multa administrativa en virtud del ar|Col2|Col3|
|---|---|---|
||USO INTERNORESTRINGIDO|Fecha de vigor: 26/02/2025|
...
|os Estados miembros estable|cerán el régimen de sanciones aplicables a cualquier incumplimiento de las disposicione|
|---|---|
...
|**Evaluación de****Impacto de****Protección de**|Cuando el tratamiento de datos personales pueda resultar un altoriesgo para los derechos y libertades de los ciudadanos, SPIKATECH debe realizar una Evaluación de Impacto de Protección de|
|**Datos**|Datos antes de iniciar con el tratamiento de los datos.La EDPB (European Data Protection Board) reitera que laimplementación de servicios en la nube por parte de organismospúblicos con frecuencia desencadena un alto riesgo.|
...
|nexo I, punto 2, letra b)nexo I, punto 2, letra c), incisos i) y inexo II|Artículo 11, apartado 4i) Artículo 11, apartado 5, letra a)Anexo I|
|---|---|
...
> Table omitted (Table 38): duplicated data detected.
> Source document: NRM 002.01_ SERVICIOS CLOUD.pdf
