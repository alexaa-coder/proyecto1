---
title: "PROCEDIMIENTO DE DESARROLLO SEGURO"
sidebar_label: "PROCEDIMIENTO DE DESARROLLO SEGURO"
...
context.Query().FromSql(sensitiveQuery); // Sensitive
...
|o Documentar las conlas mismas.|figuraciones de cada equipo de red, realizando backups de|
|---|---|
|Las pruebas de seguridad se pupruebas estáticas. Normalmente spruebas en dos informes diferente• **Pruebas dinámicas (DA**|eden dividir en dos categorías principales: pruebas dinámica  e entregarán al responsable del contrato los resultados de e  s o en dos apartados diferenciados dentro de un único inform** ST o pentest)**: estas pruebas se centran en la detección|
|vulnerabilidades que pueddinámicas pueden incluir p|en ser explotadas durante la ejecución del software. Las prue  ruebas de caja negra, pruebas de caja blanca y pruebas de|
|gris.En un sistema de informa|ión con superficie de exposición a internet la seguridad no|
|depende del software, sinopenetración o pentesting d|  del conjunto hardware/software. En este sentido, las pruebas  eben realizarse sobre la infraestructura en producción, de m|
|que intervengan todos los|  elementos del sistema involucrados.|
|• **Pruebas estáticas (SAS**analizando el código fuenvulnerabilidades de formaarquitectura del componen|** T o auditoría de código)**: las pruebas estáticas se reali  te del software. Estas pruebas se centran en la detección  interna, desde la lectura del código y la propia revisión d te software.|
|Los informes de pruebas de se|uridad deben ser claros, concisos y fáciles de entender.|
|informes incluirán la siguiente info• Descripción de cada una d|rmación:  e las vulnerabilidades que se encontraron.|
...
&gt; Table omitted (Table 44): duplicated data detected.
...
|detectarlos y de responder adecuadamente a ellos.Entre tales requisitos, se distinguen que:|Col2|Col3|Col4|
|---|---|---|---|
