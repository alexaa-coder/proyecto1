...
-   Proyecto OWASP (Open Web Application Security Project)     
...
-   La primera abordará las medidas generales necesarias para cumplir
    con los requisitos de diferentes estándares de seguridad (ISO 27001,
    ENS, OWASP,etc) en lo referente al desarrollo seguro de
    aplicaciones, proporcionando un marco común para garantizar la
    protección adecuada de los sistemas y la información.

-   La segunda sección estará dedicada a las medidas específicas que
    deben implementarse en cada una de las fases del ciclo de desarrollo
    seguro de aplicaciones, detallando las acciones concretas a seguir
    en cada etapa para asegurar la integridad y seguridad del software.
