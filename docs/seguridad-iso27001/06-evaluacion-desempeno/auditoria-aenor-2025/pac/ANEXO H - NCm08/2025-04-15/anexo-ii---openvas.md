...
|---|---|---|---|---|---|
|VulneWordVulneWordVulneWordVulneICMP|rabilityPress Shortcodes UltimatrabilityPress Shortcodes Ultimatrability|e Plugin &lt; 7.0.4 -Contrie Plugin &lt; 7.0.5 -Contri|butor+ Stored XSSbutor+ Stored XSS|Medium5.410Medium5.410Medium5.510||
|VulneWordVulneWordVulneWordVulneICMP|Press Shortcodes Ultimatrability Timestamp Reply Inform|e Plugin &lt; 7.1.3 -Contribation Disclosure|utor+ Stored XSS|Medium5.410Low2.110|Medium5.410Low2.110|
|VulneWordVulneWordVulneWordVulneICMP||||||
|VulneWordVulneWordVulneWordVulneICMP||||||
...
![](/img/anexo-ii---openvas/Anexo-II---OpenVAS.pdf-11-0.png)
