...
|Firma:|`Firmado por POZO``SANCHEZ DAVID -``***6992** el día``19/03/2025`   |`Firmado por``RODRIGO RIVERO,``CARLOS``(AUTENTICACIÓN) el``día 19/03/2025 con`|`Firmado por``***8264** CARLOS``ZUÑIGA (R:``****8690*) el día`~~`19/03/2025 con un`~~|
...
|Col1|6 Requisitos de seguridad de las ap|Col3|Col4|Col5|
|---|---|---|---|---|
|||USO OFICIAL INTERNO|USO OFICIAL INTERNO|Fecha de vigor: 19/03/2025|
||||||
||||||
|Para toda aquella información cla|Para toda aquella información cla|Para toda aquella información cla|sificada como “crítica y esencial” se definirán los estándares|sificada como “crítica y esencial” se definirán los estándares|
|de respaldo, que incluirán, al men|de respaldo, que incluirán, al men|de respaldo, que incluirán, al men|   os la siguiente información:|   os la siguiente información:|
|• Periodicidad de las copias de respaldo.|• Periodicidad de las copias de respaldo.|• Periodicidad de las copias de respaldo.|• Periodicidad de las copias de respaldo.|• Periodicidad de las copias de respaldo.|
|• Periodos de retención de las copias.• Ubicación de los soportes de respaldo, si fuera de aplicación. |• Periodos de retención de las copias.• Ubicación de los soportes de respaldo, si fuera de aplicación. |• Periodos de retención de las copias.• Ubicación de los soportes de respaldo, si fuera de aplicación. |• Periodos de retención de las copias.• Ubicación de los soportes de respaldo, si fuera de aplicación. |• Periodos de retención de las copias.• Ubicación de los soportes de respaldo, si fuera de aplicación. |
|• Procedimientos de recuperación de la información• Procedimientos de inventario.**3.1 Tipos de copias de respaldo****Completa **Se efectúa una copia de seguridad completa de todos los ficheros y bases de datos. Puedeconsumir bastante tiempo si el volumen de datos a salvaguardar es elevado. La ventaja|• Procedimientos de recuperación de la información• Procedimientos de inventario.**3.1 Tipos de copias de respaldo****Completa **Se efectúa una copia de seguridad completa de todos los ficheros y bases de datos. Puedeconsumir bastante tiempo si el volumen de datos a salvaguardar es elevado. La ventaja|• Procedimientos de recuperación de la información• Procedimientos de inventario.**3.1 Tipos de copias de respaldo****Completa **Se efectúa una copia de seguridad completa de todos los ficheros y bases de datos. Puedeconsumir bastante tiempo si el volumen de datos a salvaguardar es elevado. La ventaja|• Procedimientos de recuperación de la información• Procedimientos de inventario.**3.1 Tipos de copias de respaldo****Completa **Se efectúa una copia de seguridad completa de todos los ficheros y bases de datos. Puedeconsumir bastante tiempo si el volumen de datos a salvaguardar es elevado. La ventaja|• Procedimientos de recuperación de la información• Procedimientos de inventario.**3.1 Tipos de copias de respaldo****Completa **Se efectúa una copia de seguridad completa de todos los ficheros y bases de datos. Puedeconsumir bastante tiempo si el volumen de datos a salvaguardar es elevado. La ventaja|
|derivada de este tipo de copia eslos datos en el momento de la sa|derivada de este tipo de copia eslos datos en el momento de la sa|derivada de este tipo de copia eslos datos en el momento de la sa|    que se tiene la seguridad de tener una imagen completa de    vaguarda.|    que se tiene la seguridad de tener una imagen completa de    vaguarda.|
...
![](/img/pro-01302-copias-de-seguridad/PRO-013.02_COPIAS-DE-SEGURIDAD.pdf-11-1.png)
...
![](/img/pro-01302-copias-de-seguridad/PRO-013.02_COPIAS-DE-SEGURIDAD.pdf-11-2.png)
...
![](/img/pro-01302-copias-de-seguridad/PRO-013.02_COPIAS-DE-SEGURIDAD.pdf-11-3.png)