...
|CN-CERT|Col2|Col3|
|---|---|---|
| **CCN-STIC-885B** **Guía de configur****3.1.1.5 MECANISMOS DE A**|** UTENTICACIÓN (USUARIOS EX**|**  TERNOS)**|


|Col1|Col2|Col3|Col4|Col5|
|---|---|---|---|---|
|aplicacioGuía de Informrelacionaconfigur En el**Online:** Se exde Micro|||||
|||||SharePoint Online, como el sitio raíz,_mySite_ y elsitio de administración. La cookie de_autenticación__de Federación raíz_ (rtFA) se usa en todos losSharePoint Online. Cuando un usuario visita unnuevo sitio de alto nivel o la página de otraempresa, la cookie rtFA se usa para autenticarlasen modo silencioso sin que se le pregunte.Cuando un usuario cierra sesión en SharePointOnline, se elimina la cookie rtFA. |
|**Sesión y**De fo**sesión**. Elugar, se Microsof|||||
|**Sesión y**De fo**sesión**. Elugar, se Microsof||** cookies persiste**|** cookies persiste**|** cookies persiste**|
|**Sesión y**De fo**sesión**. Elugar, se Microsof|| rma predetermi stas cookies no eliminan siemprt Entra ID mues| rma predetermi stas cookies no eliminan siemprt Entra ID mues| rma predetermi stas cookies no eliminan siemprt Entra ID mues|
...
> Source document: CCN-STIC-885B - Guía de configuración segura para SharePoint Online.pdf
