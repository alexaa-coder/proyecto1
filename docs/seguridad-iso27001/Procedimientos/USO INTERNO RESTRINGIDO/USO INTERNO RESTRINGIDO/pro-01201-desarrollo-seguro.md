...
|Col1|PROCEDIMIENTO DEGESTIÓN DE CAMBIOS TICPROCEDIMIENTO DEGESTIÓN Y NOTIFICACIÓNDE INCIDENTES DE SEGURIDAD|Código: PRO-019.01Código: PRO-015.02|
|---|---|---|
||USO OFICIAL INTERNO_RESTRINGIDO_|Fecha de vigor: 12/03/2025 |
...
|Col1|PROCEDIMIENTO DESEGREGACIÓN DE REDES Y|Código: PRO-020.01|
|---|---|---|
||USO OFICIAL INTERNO_RESTRINGIDO_|Fecha de vigor: 12/03/2025 |
...
|El objeto del presente documento es establecer las medidaspermitan fortalecer las redes de comunicación de SPIKA TEC|de seguridad oportunas que|Col3|Col4|
|---|---|---|---|
||**MEDIA**|**ALTA**|**COMPROBACIÓN**|
...
|generan registros detallados del tráfico existente en ltráfico que ha sido permitido, como bloqueado, según la|a red SPIKA TECH, tanto del|Col3|Col4|
|---|---|---|---|
||**MEDIA**|**ALTA**|**COMPROBACIÓN**|
