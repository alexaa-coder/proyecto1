...
![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-0-0.png)

![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-0-1.png)
...
![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-1-0.png)
...
|Firma:|   `Firmado por POZO``SANCHEZ DAVID -``***6992** el día``26/02/2025`|     `Firmado por``RODRIGO RIVERO,``CARLOS``(AUTENTICACIÓN)``el día 26/02/2025`|`Firmado por``***8264** CARLOS``ZUÑIGA (R:``****8690*) el día`|
|Fecha:|26/02/2025|26/02/2025|26/02/2025~~`6/02/2025 con un`~~|


|Col1|PROCEDIMIENTO DEGESTIÓN Y NOTIFICACIÓNDE INCIDENTES DE SEGURIDADUSO OFICIAL INTERNO|Código: PRO-015.01Código: PRO-012.01|
|---|---|---|
||USO OFICIAL INTERNO|Fecha de vigor: 26/02/2025|



![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-2-0.png)
## **CONTENIDO**
...
|3.5 Automatización del sistema de Backup 3.6 Almacenamiento y traslado de soportes 3.7 Período de retención de las Copias de respaldo 3.8 Control de acceso 4 GENERACIÓN DE COPIAS DE RESPALDO|Col2|
|---|---|
|4 GENERACIÓN DE COPIAS DE RESPALDO 4.1 Procedimiento de generación de copias de respaldo|4 GENERACIÓN DE COPIAS DE RESPALDO 4.1 Procedimiento de generación de copias de respaldo|
| 4.1.1 Datos a| guardar |
|4.1.2 Política4.1.3 Proced5 PROCESO D 8|de copias de seguridad imiento de verificación de copias de respaldo  E RECUPERACIÓN DE ACTIVOS A PARTIR DE COPIAS DE RESPALDO|
|5.1 Solicitud5.2 Recupera6 COMPROBAC6.1.1 Proced|de Recuperación de Activos ción de Activos IÓN PERIÓDICA DE LOS PROCEDIMIENTOS DE RESTAURACIÓN imiento de Comprobación|
|7 REFERENCIA8 ANEXO I: PL9 ANEXO II: PL|S  AZOS LEGALES DE RETENCIÓN  AZOS LEGALES DE RETENCIÓN|
...
![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-3-0.png)
## **1 OBJETIVO Y ÁMBITO DE APLICACIÓN**
...
![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-4-0.png)
...
![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-5-0.png)
...
Siempre que sea posible, los backups se deben sutomatizar. La automatización de los
...
![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-6-0.png)
...
SPIKA TECH dispone de un listado de servidores críticos sobre los que ejecutar las copias de


respaldo. Para aquella información de mayor criticidad, se realizará una tercera copia de
...
|---|---|---|
||PROCEDIMIENTO DECOPIAS DE SEGURIDAD|Código: PRO-013.01|
||Y RESPALDO||
||USO OFICIAL INTERNO|Fecha de vigor: 26/02/2025|
||||
...
![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-7-0.png)


 - Backup diario: copia incremental o completa de todos los datos, aplicaciones y


servidores críticos de la compañía.
...
La herramienta de generación de copias de respaldo de SPIKA TECH contará con un sistema


automático de verificación de copias, en caso de que el proceso esté automatizado. Este


sistema, que se mantendrá permanentemente activado, verificará las copias de respaldo una


vez generadas y almacenará el resultado de la operación en el registro del sistema.


Se comprueba semanal el registro del sistema, al objeto de garantizar la correcta ejecución
...
![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-8-0.png)
...
![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-9-0.png)
...
![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-10-0.png)
...
![](/img/pro-01301-copias-de-seguridad/PRO-013.01_COPIAS-DE-SEGURIDAD.pdf-11-0.png)
...
|**Medio**|Completa|1 semana|1 años|Físico|
