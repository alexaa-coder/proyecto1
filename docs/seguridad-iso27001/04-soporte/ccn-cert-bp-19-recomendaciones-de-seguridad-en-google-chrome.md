...
|2. Int|troducción|
|---|---|
|**2. In****El propósito de****establecer los****necesarias par****seguridad en****_Go_**Para ello, se proporciomedidas de seguridadseguridad.Este documento estably **proteger el navegad**vulnerabilidades y los riEn el desarrollo de esta_Google Chrome_ en suWindows.|** troducción****  este documento consiste en**** procedimientos y utilidades**** a implementar y garantizar la****_ogle Chrome_.**  na un archivo de confguración para aplicar  y así facilitar la posibilidad de implementar ece un procedimiento para** mejorar la seguridad**** or** _Google Chrome_ para mitigar las posibles  esgos frente a los que pudiera estar expuesto.   guía se ha utilizado el instalador del programa **versión 89.0.4389** para sistemas operativos|
|||
