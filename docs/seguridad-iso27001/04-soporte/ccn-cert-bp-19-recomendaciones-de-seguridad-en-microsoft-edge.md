...
El Canal Beta está destinado a la implementación de pruebas en producción para

un conjunto representativo de usuarios. Este canal brinda una gran oportunidad

para validar que las configuraciones o necesidades funcionan como se espera en un

entorno. Si encuentra un problema, es posible solucionarlo antes de que se publique el

lanzamiento en el canal estable. Al igual que la versión de Microsoft Edge las nuevas

características se envían aproximadamente cada 4 semanas. Las actualizaciones de
...
El canal DEV está destinado para ayudar a planificar y desarrollar las actualizaciones

más recientes de Microsoft Edge, pero con mayor calidad que el canal Canary. Este

canal sirve para echar un vistazo anticipado a las novedades y prepararse para la
...
El canal Canary se actualiza a diario y es el más vanguardista de todos los canales. Si

se desea acceder a las características más recientes, aparecerán aquí primero.
...
|8- Cuandclick|o le deis, os aparecerá un menú desplegable. En este menú debéis haceren “Iniciar un descanso”.|
|---|---|
...
|Para hacer uso del arreemplazar el fichero crPara esto se deberá ccarpeta “Scripts” y sustEste fichero cambiará lvalores de las configuDIRECTRICES DE CONFde personalización deno se verán afectadaconfiguraciones persose deberán configurar|chivo suministrado junto a esta guía, deberáeado durante la instalación de Google Chrome.opiar el fichero “Preferences” ubicado en laituirlo en la ruta citada anteriormente.as opciones marcadas y desmarcadas con losraciones recomendadas en el apartado “3.6.IGURACIÓN” de esta guía. Las configuracionesrutas, páginas web y otro tipo de opcioness. Si se desea personalizar alguna de estasnalizadas (como la URL de inicio, por ejemplo)manualmente en el navegador Google Chrome.|
|---|---|
