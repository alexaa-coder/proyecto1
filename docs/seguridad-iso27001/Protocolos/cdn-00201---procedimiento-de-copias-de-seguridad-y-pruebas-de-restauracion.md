...
- Información almacenada en servicios CLOUD (O365, SharePoint, OneDrive,
 Exchange Online, aplicaciones SaaS).
...
- **Responsable TIC / Administrador de Sistemas:** Ejecutar y supervisar
 las copias de seguridad y pruebas de restauración.
...
- Existen mecanismos de protección contra borrado accidental, ransomware
 y corrupción.
...
- Uso de herramienta de **Backup dedicada para O365** (correo, OneDrive,
 SharePoint y Teams).
