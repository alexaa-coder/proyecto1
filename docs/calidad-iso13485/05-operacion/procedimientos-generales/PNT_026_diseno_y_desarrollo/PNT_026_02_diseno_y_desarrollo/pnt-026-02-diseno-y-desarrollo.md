...
02
Reescritura del procedimiento para ajustarse con la realidad del
proceso de diseño de SPIKA TECH, segun AC-045/24
10/05/2024
PNT-026.01
...
[5.5.1. Especificaciones [10](#especificaciones)](#especificaciones)

[5.5.2. Codificación [10](#codificación-1)](#codificación-1)
...
[11](#cambios-en-el-diseño)](#cambios-en-el-diseño)

[5.8. Análisis de Riesgos
[11](#análisis-de-riesgos)](#análisis-de-riesgos)

[5.9. Etiquetado y acondicionamiento del producto
[11](#etiquetado-y-acondicionamiento-del-producto)](#etiquetado-y-acondicionamiento-del-producto)

[5.10. Design history file [11](#_Toc166223492)](#_Toc166223492)
...
[9. Formación [12](#section-3)](#section-3)

[10. TITULO: REQUERIMIENTOS DE USUARIO
[14](#titulo-requerimientos-de-usuario)](#titulo-requerimientos-de-usuario)
...
-   Incidencia (Jira): cabe destacar que Jira emplea el termino
    ...
    incidencia real, de acuerdo, a las definiciones del PNT004 Gestion
    de no conformidades.
...
reuniones de seguimiento de forma semanal en las que se revisa lo
eleborado por todos los equipos de trabajo que conforman SPIKA y se
dictan las pautas para continuar con el desarrollo del producto.

Dichas reuniones se realizan los jueves de cada semana (en caso de ser
laborables, en caso contrario la reunión se anula y se emplaza para la
siguiente semana) usando la herramienta de Microsoft Teams, la cual
genera de forma automática un acta de resúmen de todos los puntos
tratados en la reunión, dichas actas serán alamcenadas en
...
-   Criterios de aceptación: esbozan los requisitos y límites esenciales
    para el desarrollo de una función. Incluyen una lista de
    comprobación específica y cuantificable que abarca aspectos
    funcionales y no funcionales, orientando el desarrollo y las
    pruebas. Estos criterios son fundamentales para alinear las
    expectativas del equipo y garantizar que una función cumpla los
    objetivos previstos con eficacia.
...
incluido en el **Anexo 1**: *Requerimientos de usuario de diseño*.
...
con los requerimientos de usuario y su uso intencionado. Esta fase
generará un protocolo de validación, que deberá ser revisado y aprobado
por el informador de la incidencia dentro de la herramienta Jira.

Para ello, la persona asignada a la incidencia, debe marcar esta como
“under review” lo que significa que el proceso de desarrollo ha
finalizado a falta de su verificación y posterior validación.
...
transición a la siguiente fase (verificación del diseño) en la tarjeta
correspondiente a la incidencia de Jira.
...
cabo con éxito y el informador de la incidencia se ha encargado de
verificar y validar el correcto funcionamiento del nuevo desarrollo.
