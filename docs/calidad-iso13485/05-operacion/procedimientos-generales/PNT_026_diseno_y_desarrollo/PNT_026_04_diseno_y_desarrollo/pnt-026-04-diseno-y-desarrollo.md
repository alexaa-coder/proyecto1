...
04
Expecificación de los tipos de cambios en el diseño, cambio en los
...
-   Impacto en la versión del producto: Incrementa el primer número de
    la versión del producto. (Ejemplo: de 1.0.0 a 2.0.0).
...
-   Impacto en la versión del producto: Incrementa el segundo número de
    la versión del producto. (Ejemplo: de 1.0.0 a 1.1.0).
...
-   Impacto en la versión del producto: Incrementa el tercer número de
    la versión del producto. (Ejemplo: de 1.0.0 a 1.0.1).
