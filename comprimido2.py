...
#   - 🖼️ ASSET PATH FIX: Saves images to root 'static/img' and links as '/img/...'.
#   - 🛡️ TABLE PROTECTION: Isolate tables from the cleaning pipeline.
#   - 🧹 SIGNATURE CLEANING: Remove digital certificate metadata.
#   - ⚖️ JUSTIFICATION: CSS justification for continuous text blocks.
...
class ConversionStats:
    ...
    def show_summary(self):
        ...
        if self.data["signatures"]: print(f" ✍️ Signatures cleaned: {self.data['signatures']}")
